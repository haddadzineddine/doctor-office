...
export class PrescriptionsPresenter {
    ...
    constructor(prescription: Prescription) {
        ...
        this.doctor = prescription.doctor ? new DoctorPresenter(prescription.doctor) : undefined;
        this.patient = prescription.patient ? new PatientPresenter(prescription.patient) : undefined;
    }
}